...
1. ping
Purpose: Check the connectivity between your system and a remote host. Usage:
...
Purpose: Trace the path packets take to reach a destination. Usage:
...
3. netstat
Purpose: Display network connections, routing tables, and statistics. Usage:
...
4. curl
Purpose: Transfer data from or to a server using various protocols. Usage:
